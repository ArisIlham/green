                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Tambah Admin GLE!</h1>
                                    </div>
                                    <form class="user" action="<?php echo base_url() . 'Welcome/tambah_admin_aksi'; ?>" method="post">
